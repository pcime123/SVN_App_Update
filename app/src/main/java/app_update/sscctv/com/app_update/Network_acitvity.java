...
import app_update.sscctv.com.app_update.R;
...
public class Network_acitvity extends Fragment {
    private static final String UPDATE_CHANNEL = "stable";

    private static final String PACKAGE_LAUNCHER = "com.sscctv.packetAnalyzer";
    private static final String TAG = "App Update[Network]";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.activity_network, null);
        now_ver = view.findViewById(R.id.network_version);
        new_ver = view.findViewById(R.id.network_latest);

        checkButton = view.findViewById(R.id.network_check_btn);
        updateButton = view.findViewById(R.id.network_update_btn);
        message = view.findViewById(R.id.network_message);
...
//            v3 = Version.valueOf(pi.versionName);
            Log.d(TAG, "network: " + pi.versionName);
