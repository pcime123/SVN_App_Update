...
public class Manual_acitvity extends Fragment {
    private static final String UPDATE_CHANNEL = "stable";

    private static final String PACKAGE_LAUNCHER = "com.manual.ipm07pro";
    private static final String TAG = "App Update[Manual]";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.activity_manual, null);
        now_ver = view.findViewById(R.id.manual_version);
        new_ver = view.findViewById(R.id.manual_latest);

        checkButton = view.findViewById(R.id.manual_check_btn);
        updateButton = view.findViewById(R.id.manual_update_btn);
        message = view.findViewById(R.id.manual_message);
...
//            v3 = Version.valueOf(pi.versionName);
            Log.d(TAG, "manual: " + pi.versionName);
